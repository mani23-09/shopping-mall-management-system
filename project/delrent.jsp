...
try
{
    ...
    int i=st.executeUpdate("delete from rent where rno='"+id1+"'");
	con.close();
    if(i > 0)
{
...
<a href="delrent.html" style="height:25px;width: 100px;background-color: aliceblue;text-decoration: none;cursor: pointer;text-align: center;box-shadow: 3px 3px 5px white;">back</a>
</body>
</html>

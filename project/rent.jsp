...
try
{
    ...
    int i=st.executeUpdate("insert into rent(rno,said,ramo,rpm,rpy,rpd)values('"+id1+"','"+fno1+"','"+sname1+"','"+rpm1+"','"+sss1+"','"+bamo1+"')");
	con.close();
...
%>
<a href="rent.html" style="height:25px;width: 100px;background-color: aliceblue;text-decoration: none;cursor: pointer;text-align: center;box-shadow: 3px 3px 5px white;">back</a>
</body>
</html>

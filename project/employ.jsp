...
try
{
    ...
    int i=st.executeUpdate("insert into emp(id,ena,dob,gen,edu,qua,address,pno,post,salary,jodate)values('"+id1+"','"+ena1+"','"+dob1+"','"+gen1+"','"+edu1+"','"+qua1+"','"+add1+"','"+pno1+"','"+post1+"','"+salary1+"','"+jodate1+"')");
	con.close();  
...
%>
<a href="addemploy.html" style="height:25px;width: 100px;background-color: aliceblue;text-decoration: none;cursor: pointer;text-align: center;box-shadow: 3px 3px 5px white;">back</a>
</body>
</html>